var viewportWidth = function getViewportWidth(){
...
let tut2 = new Tutorial("Professionelles Atmen", "Deutsch", "second best tutorial on earth","00:28","2017-8-23","no url","no embed")
...
// Bei der Ausgabe kommt noch keine Liste der Tutorials heraus die, die Kategorie Körperliche Tätigkeiten haben
//console.log(getTutorialsZuKategorie("Körperliche tätigkeiten"));

for (const datensatz of katarray) {
    console.log(`Kategorie: ${datensatz.name}`);
    console.log(`Bild: ${datensatz.bild.name}`);
        if (getTutorialsZuKategorie(`${datensatz.name}`).length > 0) {
            console.log('Tutorials:');
            for (const tutorial of getTutorialsZuKategorie(`${datensatz.name}`)){
                console.log(`${tutorial.name}`);
                console.log(`${tutorial.datum}`);
                console.log(`${tutorial.beschreibung}`);
                console.log(`${tutorial.dauer}`);
                console.log(`${tutorial.url}`);
                    if(`${tutorial.kapitelliste.length}`.length > 0){
                        console.log('Kapitel:');
                        for (let j=0; j < `${tutorial.kapitelliste.length}`; j++){
                            console.log(`${tutorial.kapitelliste[j].name}`);
                            console.log(`${tutorial.kapitelliste[j].beschreibung}`);
                            console.log(`${tutorial.kapitelliste[j].dauer}`);
                        }
                    }
            }
        }
